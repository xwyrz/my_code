...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://github.com/sprov065/soga/releases/download/${last_version}/soga-linux-amd64.tar.gz
        ...
        last_version=$1
        url="https://github.com/sprov065/soga/releases/download/${last_version}/soga-linux-amd64.tar.gz"
